  ...
  mailboxes: [
    {
      ...
      messages: [
        {
        id: 1,
        subject: "Welcome to JML",
        from: "adam@example.com",
        to: "user@example.com",
        date: new Date(),
        body: "Welcome to JML. We hope you enjoy your stay"
        }, {
        id: 2,
        subject: "Great JML Resources",
        from: "adam@example.com",
        to: "user@example.com",
        date: new Date(),
    ...
    },
    {
      ...
      messages: [
        {
        id: 4,
        subject: "Should I use JML",
        from: "user@example.com",
        to: "adam@example.com",
        date: new Date(),
        body: "JML looks pretty good, should I use it?"
        }
      ]
    }
  ]
